...
class BraveTranslateManagerTest : public ::testing::Test {
 protected:
  BraveTranslateManagerTest()
...
TEST_F(BraveTranslateManagerTest, CanManuallyTranslate_WithoutAPIKey) {
...
TEST_F(BraveTranslateManagerTest, CanManuallyTranslate_WithAPIKey) {
  const std::string api_key = ::google_apis::GetAPIKey();
